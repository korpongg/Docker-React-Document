    ...
    <>
      ...
      <div className="GeneralBox">
        ...
        >
          <div
            className={
              missingKeys.some((item) => item.key === "impromptusolution")
                ? "AreaBOX SETERRORBOX"
                : "AreaBOX"
            }
          >
          ...
          <div
            className={
              missingKeys.some((item) => item.key === "activefailure")
                ? "AreaBOX SETERRORBOX"
                : "AreaBOX"
            }
          >
            <TextField
              ...
              value={data?.activefailure || ""}
              onChange={(e) => setDataFunction(e, "activefailure")}
              variant="filled"
              multiline
              rows={2}
              sx={{ marginBottom: 1 }}
