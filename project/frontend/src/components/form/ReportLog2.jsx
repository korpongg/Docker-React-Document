...
import AutoCompleteText2 from "./AutoCompleteText2";
import AutoCompleteTextSingle from "./AutoCompleteTextSingle";
import { getCurrentDate } from "../Function";
import Divider from '@mui/material/Divider';

const ReportLog2 = ({ FormType,Mode, data, setDataFunction,setSingleDataFunction, handleDateChange, handleDataChangeCheckbox, missingKeys }) => {
  return (
    <>
      {FormType==="Occ" &&
                <AutoCompleteText2
                  ...
                  Mode={Mode}
                  data={data}
                  datacolumn="deptrelate2"
                  datacolumn2="deptemail2"
                  handleDataChangeCheckbox={handleDataChangeCheckbox}
                />
              }
              {FormType==="Med" &&
                <AutoCompleteTextSingle
                  required
                  Mode={Mode}
                  data={data}
                  datacolumn="deptrelate2"
