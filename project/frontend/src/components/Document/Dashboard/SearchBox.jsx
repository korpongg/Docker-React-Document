        ...
        <Grid2 container spacing={2}>
          ...
          <Grid2 container spacing={1} xs={12} md={6} align="center" justify="center" alignItems="center">
            {reportType !== 'Medication' ? (
              <>
                <Grid2 xs={12} md={4} align="right">ประเภทข้อร้องเรียน</Grid2>
                <Grid2 xs={12} md={8}>
                  <FormControl fullWidth variant="outlined">
                    <InputLabel>ประเภทข้อร้องเรียน</InputLabel>
                    <Select
                      value={incidentType}
                ...
                <Grid2 xs={12} md={8}>
                  <FormControl fullWidth variant="outlined">
                    ...
                    >
                      ...
                      <MenuItem value="6">ไม่ใช่ข้อร้องเรียน</MenuItem>
                    </Select>
                  </FormControl>
                </Grid2>
              </>
              ...
              <Grid2 xs={12} md={8}>
                <FormControl fullWidth variant="outlined">
                  ...
                  >
                    <MenuItem value="-">แสดงผลทั้งหมด</MenuItem>
                    <MenuItem value="0">แบบร่าง</MenuItem>
                    <MenuItem value="1">ข้อร้องเรียนใหม่</MenuItem>
                    <MenuItem value="2">ปิดข้อร้องเรียน</MenuItem>
                    <MenuItem value="3">ยกเลิก</MenuItem>
                    <MenuItem value="4">อยู่ระหว่างทบทวน</MenuItem>
                    <MenuItem value="5">ไม่ใช่ข้อร้องเรียน</MenuItem>
                  </Select>
                </FormControl>
              </Grid2>
            </Grid2>
